...
window.addEventListener("keydown", function (e) {
  ...
  if (player.position.x = (currentRoomx - 160) && player.position.y = currentRoomy){
    console.log("moveRight");
  }
  if (player.position.x = (currentRoomx + 160) && player.position.y = currentRoomy){
    console.log("moveLeft");
  }
  if (Math.abs(player.position.x - (currentRoomx - 16)) < 30 && player.position.y = currentRoomy + 160){
    console.log("moveUp");
  }
  if (Math.abs(player.position.x - (currentRoomx - 16) && player.position.y = currentRoomy - 160){
